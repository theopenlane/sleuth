...
func TestIsNucleiAvailable(t *testing.T) {
	...
	available := scanner.isNucleiAvailable(context.Background())
...
func TestPerformNucleiScan_NucleiNotAvailable(t *testing.T) {
	...
	originalPath := scanner.options.NucleiPath
	scanner.options.NucleiPath = "/nonexistent/nuclei"
	...
	scanner.options.NucleiPath = originalPath
...
func TestGetNucleiVersion(t *testing.T) {
	...
	version, err := scanner.GetNucleiVersion(context.Background())
...
func TestPerformNucleiScan_Integration(t *testing.T) {
	...
	if !scanner.isNucleiAvailable(context.Background()) {
