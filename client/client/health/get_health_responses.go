...
func (o *GetHealthReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type GetHealthOK struct {
	Payload *models.APIHealthResponse
}
